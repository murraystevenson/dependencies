{
	...
	"downloads" : [
		...
		"https://github.com/blender/cycles/archive/refs/tags/v4.1.1.tar.gz",
	...
	"dependencies" : [ "Boost", "OpenJPEG", "OpenImageIO", "TBB", "Alembic", "Embree", "OpenColorIO", "OpenVDB", "OpenShadingLanguage", "OpenSubdiv", "OpenPGL", "LibWebP", "OpenImageDenoise" ],

	"commands" : [

		# The Cycles 4.1.1 archive includes empty folders under `./lib`
